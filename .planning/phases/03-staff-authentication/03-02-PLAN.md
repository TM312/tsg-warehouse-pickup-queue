...
depends_on: ["03-01"]
files_modified:
  - staff/pages/login.vue
  - staff/pages/forgot-password.vue
  - staff/pages/password/update.vue
  - staff/pages/confirm.vue
  - staff/pages/settings.vue
  - staff/pages/index.vue
  - staff/components/PasswordChangeForm.vue
autonomous: false
user_setup:
  - service: supabase
...
1. Set up Supabase (if not done):
   ...
   - Create staff/.env with these values (copy from staff/.env.example)
