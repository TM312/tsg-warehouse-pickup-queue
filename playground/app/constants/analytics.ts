...
export const KPI_DEFINITIONS: KpiDefinition[] = [
  { id: 'completed-count', key: 'completedCount', label: 'Completed Today', icon: CheckCircle2, format: numOrZero, animate: true },
  { id: 'avg-wait-time', key: 'avgWaitTime', label: 'Avg Wait Time', icon: Clock, format: formatDurationMs, animate: false },
  { id: 'avg-processing-time', key: 'avgProcessingTime', label: 'Avg Processing Time', icon: Timer, format: formatDurationMs, animate: false },
  { id: 'currently-waiting', key: 'currentlyWaiting', label: 'Currently Waiting', icon: Users, format: numOrZero, animate: true },
]
...
export const EVENT_TYPE_CONFIG: Record<SimulationEventType, { icon: Component; colorClass: string }> = {
  ...
  assign: { icon: ArrowRight, colorClass: 'text-violet-500' },
